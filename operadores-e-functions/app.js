...
const validarNumeroInformado = (numero) => {
    ...
    if(!resultado){
        console.log('numero informado não e valido');
    }
    return resultado
            ...
            if(operadorValidado){
                switch(operadorValidado){
                    ...
                    case '-' : console.log(`operador selecionado subtracao resultado ${numeroValidado1} - ${numeroValidado2}= ${numeroValidado1-numeroValidado2}`);
                       break;
                    case '*' : console.log(`operador selecionado multplicao resultado ${numeroValidado1} * ${numeroValidado2}= ${numeroValidado1*numeroValidado2}`);
                       break;
